...
from text2sg.prompts.cross import CROSS_SPEC, build_user_cross
from text2sg.prompts.diagnose import DIAGNOSE_SPEC, build_user_diagnose
from text2sg.prompts.extract import EXTRACT_SPEC
from text2sg.prompts.fresh import FRESH_SPEC, build_user_fresh
from text2sg.prompts.meta_review import META_REVIEW_SPEC, build_user_meta_review
from text2sg.prompts.propose import PROPOSE_SPEC, SYSTEM_PROPOSE, build_user_propose
from text2sg.prompts.verify import VERIFY_SPEC
from text2sg.prompts._authored import (
    SYSTEM_CROSS, SYSTEM_DIAGNOSE, SYSTEM_FRESH, SYSTEM_META_REVIEW,
)
